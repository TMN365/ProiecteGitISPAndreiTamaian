...
public class SafeHomeTest {
    ...
    public void whenTenantNotFoundThanRemoveTenantThrowsException() {
        try {
            ...
            fail("Exception should be thrown!");
            //Testul nu merge pentru Map empty, deoare am mai introdus o exceptie NoTenantException si s-ar duce pe aceasta in loc de TenantNotFoundException
        } catch (Exception ex) {
